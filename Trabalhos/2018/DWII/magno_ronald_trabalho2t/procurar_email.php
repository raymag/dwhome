...
<body>
    ...
    <div class="bloco">
        <form method="POST">
        <label>Procurar: <input type="text" autofocus autocomplete="off" name="email_alvo" onKeyUp="searchUser(this.value)" placeholder="Fragmento de nome ou e-mail"> </label>
        <!-- <input type="submit" value="Pesquisar"> -->
        </form>
    </div>
    <div class="bloco">
    <p id="search-result">Primeiro pesquise por um email.</p>
    ...
    // if(isset($_POST["email_alvo"]) && isset($_POST["email_alvo"][0]) ){
