...
<body>
    ...
    <div class="bloco">
        ...
        if(isset($_GET["mailto"])){
            ...
            echo '<label>E-mail: <input type="email" required name="email_alvo" placeholder="Ex: paula@tejan.do"> </label>';
        }
        ?>
        ...
        <fieldset>
            ...
            <textarea name="texto" maxLength="400" required cols="60" rows="10"></textarea>
        </fieldset>
